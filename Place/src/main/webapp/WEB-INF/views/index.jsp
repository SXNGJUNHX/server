...
<body class="wide">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=586417bd74c6838d39bb1a5c4ea0c652&libraries=services"></script>
			...
			$.ajax({
				...
				success: function(result) {
					...
					result.forEach(obj => {
						...
						//장소 1개 > 아이템 1개
						$('#list').append(`
							<div onclick="selPlace(\${obj.seq});">\${obj.name}</div>		
						`);
