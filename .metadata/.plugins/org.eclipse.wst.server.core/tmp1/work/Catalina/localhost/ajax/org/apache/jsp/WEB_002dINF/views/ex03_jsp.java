 ...
 * Generated at: 2024-04-09 05:17:23 UTC
...
public final class ex03_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	\r\n");
      out.write("	<!-- 버튼 클릭 > 서버의 데이터를 가져와서 화면에 출력하기 -->\r\n");
      out.write("	<form action=\"/ajax/ex03data.do\">\r\n");
      out.write("		<div><a href=\"/ajax/ex03data.do\">확인하기</a></div>\r\n");
      out.write("		<div><input type=\"submit\" value=\"확인하기\"></div>\r\n");
      out.write("		<div><input type=\"button\" value=\"확인하기\" id=\"btn1\"></div>\r\n");
      out.write("		<hr>\r\n");
      out.write("		<xmp class=\"message\">");
      ...
      out.write("	<hr>\r\n");
      out.write("	<div>\r\n");
      out.write("		다른 업무: <input type=\"text\">\r\n");
      out.write("	</div>\r\n");
      out.write("	\r\n");
      ...
      out.write("			/*\r\n");
      out.write("				Ajax\r\n");
      out.write("				1. 순수 자바스크립트\r\n");
      out.write("				2. 각종 라이브러리(jQuery)\r\n");
      out.write("			*/\r\n");
      out.write("			\r\n");
      out.write("			//Ajax > 서버에게 요청 + 응답 > Ajax 객체\r\n");
      out.write("			const ajax = new XMLHttpRequest();\r\n");
      out.write("			\r\n");
      out.write("			ajax.onreadystatechange = function() {\r\n");
      out.write("				//$('.message').append('<div>수신 완료</div>');\r\n");
      out.write("				//$('.message').append(`<div>${ajax.status}</div>`);\r\n");
      out.write("				\r\n");
      out.write("				if(ajax.readyState == 4 && ajax.status == 200){\r\n");
      out.write("					\r\n");
      out.write("					//서버가 돌려준 데이터\r\n");
      out.write("					$('.message').append(ajax.responseText);\r\n");
      out.write("					//alert(ajax.responseText);\r\n");
      out.write("					\r\n");
      out.write("				}\r\n");
      out.write("			};\r\n");
      out.write("			\r\n");
      out.write("			//<form method=\"GET\" action=\"/ajax/ex03.txt\">\r\n");
      out.write("			//ajax.open('GET', '/ajax/ex03.txt'); //연결(X), 설정(O)\r\n");
      out.write("			ajax.open('GET', '/ajax/ex01.do');\r\n");
      out.write("			\r\n");
      out.write("			ajax.send(); //실제 요청 + 서버와 연결 > 전송 버튼 or 링크 클릭					\r\n");
      out.write("			\r\n");
      out.write("		});\r\n");
      out.write("	\r\n");
      out.write("	</script>\r\n");
