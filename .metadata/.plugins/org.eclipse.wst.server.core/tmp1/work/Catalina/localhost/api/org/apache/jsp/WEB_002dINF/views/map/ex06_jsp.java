 ...
 * Generated at: 2024-04-09 00:23:15 UTC
...
public final class ex06_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<body>\r\n");
      out.write("	<!-- ex06.jsp -->\r\n");
      out.write("	<h1>지도 <small>주소를 좌표 얻기</small></h1>\r\n");
      out.write("	\r\n");
      out.write("	<div>\r\n");
      ...
      out.write("	<hr>\r\n");
      out.write("	<div>\r\n");
      out.write("		<input type=\"text\" id=\"address\" class=\"full\"\r\n");
      ...
      out.write("		\r\n");
      out.write("		$('#address').keydown(function(evt) {\r\n");
      out.write("			if (evt.keyCode == 13) {\r\n");
      out.write("				//alert($(this).val());\r\n");
      out.write("				\r\n");
      out.write("				search($(this).val());\r\n");
      out.write("				\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      ...
      out.write("		\r\n");
      out.write("		function search(address) {\r\n");
      out.write("			\r\n");
      out.write("			const geocoder = new kakao.maps.services.Geocoder();\r\n");
      out.write("			\r\n");
      out.write("			geocoder.addressSearch(address, function(result, status) {\r\n");
      out.write("				\r\n");
      out.write("				//alert(result[0].y + \",\" + result[0].x);\r\n");
      out.write("				\r\n");
      out.write("				if(status == kakao.maps.services.Status.OK){\r\n");
      out.write("					\r\n");
      out.write("					const p =  new kakao.maps.LatLng(result[0].y, result[0].x);\r\n");
      out.write("					\r\n");
      ...
      out.write("						position: p\r\n");
      out.write("					});\r\n");
      out.write("					\r\n");
      out.write("					m1.setMap(map);\r\n");
      out.write("					\r\n");
      out.write("					map.panTo(p);\r\n");
      out.write("				} else {\r\n");
      out.write("					alert('검색 실패');\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("			});\r\n");
      out.write("			\r\n");
